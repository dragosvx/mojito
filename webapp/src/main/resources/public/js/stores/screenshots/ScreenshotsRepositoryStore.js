...
class ScreenshotsRepositoryStore {
    ...
    constructor() {
        ...
        this.bindListeners({
            handleUpdateRepositories: ScreenshotsRepositoryActions.GET_ALL_REPOSITORIES,
            changeSelectedRepositoryIds: ScreenshotsRepositoryActions.CHANGE_SELECTED_REPOSITORY_IDS,
            resetScreenshotSearchParams: ScreenshotsPageActions.RESET_SCREENSHOT_SEARCH_PARAMS
        });
    }
