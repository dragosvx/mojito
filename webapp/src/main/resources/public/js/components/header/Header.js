        ...
        return (
            <Navbar fluid={true}>
                ...
                <Nav>
                    ...
                    <LinkContainer to="/workbench"><NavItem><FormattedMessage id="header.presentation" /></NavItem></LinkContainer>
                    <LinkContainer to="/workbench"><NavItem><FormattedMessage id="header.synonyms" /></NavItem></LinkContainer>
                </Nav>
                <Nav pullRight={true}>
